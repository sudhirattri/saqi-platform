...
export default function getTranslated(lang, searchKey){
    ...
    // console.log('answer: ',(lang=='hin')? (hin[searchKey]) : (eng[searchKey])   )
    if(!(searchKey) in eng)
